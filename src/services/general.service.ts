...
import { TEMPLATES_INFO } from './app.constants';
...
export class GeneralService {
    ...
    topicWiseData: any; // stores the basic data of topics such as name,id,chapter, etc..
    templatesInfo: any;//object to map the template name from server to template page name at client side


    constructor(private http: CustomHttpService) {

        this.templatesInfo = TEMPLATES_INFO;
    }
